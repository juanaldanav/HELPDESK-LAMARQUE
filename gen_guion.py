...
step(2, "Toca “Reportar un problema”. Llena: título, categoría y descripción. Señala que NO hay selector de urgencia: la prioridad la asigna el sistema según la categoría (práctica ITIL: evita el “todo es urgente”) y Dalia puede ajustarla. Solo existe una casilla excepcional de EMERGENCIA (riesgo o sucursal parada) que queda marcada en el hilo.")
step(3, "En “Equipo afectado” abre el menú: los activos de SU sucursal aparecen agrupados por categoría (Refrigeración, Maquinaria de café, etc.). Elige uno (ej. LMQ-GDL-REF-0005). Recalca: imposible reportar el equipo de otra sucursal.")
...
step(4, "Abre el ticket recién creado. La urgencia ya viene asignada por el sistema; Dalia puede ajustarla. En “Asignar / actualizar” muestra las dos formas de atender:")
b("Técnico interno: elige a un técnico, urgencia y una Fecha de atención → se notifica y aparece en el Calendario.")
b("Proveedor externo: cambia a “Proveedor externo”, elige uno del catálogo o crea uno nuevo (“+ Nuevo proveedor”) con su correo y teléfono.")
step(5, "Con proveedor asignado aparece su tarjeta de contacto: botón “Llamar” (marca directo desde el celular), su correo, y “Enviar ticket por correo al proveedor” → le llega el detalle completo del ticket (sucursal, equipo, descripción) sin que el proveedor entre al sistema.")
step(6, "Cuando el proveedor manda su hoja de servicio (por correo o WhatsApp), Dalia la adjunta al ticket como PDF o foto desde el comentario (“Foto / PDF”): queda para siempre en el historial de ese mantenimiento.")
step(7, "Escribe un comentario en el ticket (Dalia también chatea con sucursal y técnico).")
step(8, "Abre el Calendario: el mantenimiento quedó agendado, con colores por tipo. Haz clic en cualquier día → se abre “Agendar mantenimiento” con esa fecha lista (sucursal + tipo + técnico).")
step(9, "Abre un evento del cronograma importado y toca “✎ Editar evento”: TODO es modificable (sucursal, tipo, fecha o rango, técnico, notas). También se marca Realizado o se cancela. El cronograma 2026 vive aquí, ya no en Excel.")
...
step(2, "“Mis tareas”: muestra los tickets asignados (filtro Pendientes / En curso) Y la sección “Mantenimientos programados” — los preventivos/correctivos del calendario le llegan aquí, no solo por correo. Toca uno: se despliega el detalle (sucursal, fechas, notas) con “Marcar realizado” y, si tiene ticket ligado, “Ver ticket”.")
...
step(3, "Proveedor externo: con la hoja del proveedor ya adjunta en el hilo, Dalia usa “Cerrar ticket (coordinación)” con su nota de cierre (el proveedor no entra al sistema) — también genera la hoja PDF y notifica.")
...
b("Mantenimiento preventivo (calendario con el cronograma 2026 completo y editable) y correctivo (tickets) en un solo lugar.")
b("Atención interna (técnicos) o externa (proveedores con contacto, correo y hoja adjunta), medida en el dashboard sin exponer costos.")
b("Prioridades estilo ITIL: las asigna el sistema por categoría, no el usuario — se acabó el “todo es urgente”.")
